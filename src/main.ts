...
import { mountRoomBrowser, roomBrowserMarkup } from "./room-browser";
...
let busy = false;
let disposeRoomBrowser: (() => void) | undefined;
...
function renderPanel() {
  ...
  if (screen === "menu") {
    ...
    if (selectedMode === "online" && !busy) {
      disposeRoomBrowser = mountRoomBrowser(panel, (roomId) => {
        saveName();
        unlockAudio();
        void connectOnline(roomId);
      });
    }
